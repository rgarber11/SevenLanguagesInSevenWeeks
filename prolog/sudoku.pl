...
valid([Row1, Row2, Row3, Row4, Row5, Row6, Col1, Col2, Col3, Col4, Col5, Col6, Square1, Square2, Square3, Square4, Square5, Square6]), fd_labeling(Solution), print(Row1), print('\n'), print(Row2), print('\n'), print(Row3), print('\n'), print(Row4), print('\n'), print(Row5), print('\n'), print(Row6).
